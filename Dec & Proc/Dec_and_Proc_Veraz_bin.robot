...
${COLLECTOR_NAME_1}    Dec_Veraz_Test_bin
${COLLECTOR_NAME_2}    Proc_Veraz_Test_bin
${PATH_TO_OUTPUT_DIR}    /data/cdrs/tmp/file_perf_testing/input/L2/Dec_Veraz_Test_bin
${PATH_TO_INPUT_DIR_1}    /data/cdrs/tmp/file_perf_testing/input/L3/Dec_and_Proc_Veraz_Test_bin
